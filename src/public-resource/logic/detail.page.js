    ...
    <div class="txt-wrap fl"><h3>${item.topic}</h3><p class="tags"><em class="tag tag-time"><i class="tag">${item.source} 提供的广告</i></em></p></div><div class="img-wrap fr"><img class="lazy" src="${item.miniimg[0].src}"></div></div>
        ...
        (function () {
            ...
            let data = {
                ...
                ggurl: 'https://s.click.taobao.com/t?e=m%3D2%26s%3DGCcB4cC2yGocQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAqlHSL4Fo%2BiiGcvgIVjTTAfXO%2BqAgJq5vM8ddJICenQ6RcYLL5pMoFgo07GipboIMlH%2FhwblmzC5AgLbN2peQYN8isIqg9litAZn%2By0keumoL1zhcxbolbm1jhC3ZxnWVeoPXyFbMSxd', //广告的url
            }
            //4.百度渠道不弹窗
            if (qid === 'baiducom') {
                return
            ...
            $('#advertisement_3').on('click', function (e) {
                taobaoClick(e, this)
                // baidu(2)
                // dc('click', 'sdtcclcick')
                // e.preventDefault()
            ...
            $('#advertisement_1 .btn').on('click', function (e) {
                taobaoClick(e, this)
                // baidu(2)
                // dc('click', 'sdtcclcick')
                // e.stopPropagation()
