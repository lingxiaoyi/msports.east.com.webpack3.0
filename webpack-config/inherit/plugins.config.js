...
let configPlugins = [
    ...
    new webpack.optimize.CommonsChunkPlugin({
        names: ['static/commons/commons', 'static/commons/ad.channel'], // chunk的名字,需要注意的是，chunk的name不能相同！！！ 提取出ad js 因为这个广告JS改动最频繁 不分前后顺序
...
pageArr.forEach((page) => {
    ...
    const htmlPlugin = new HtmlWebpackPlugin({
        ...
        chunks: ['manifest', page, 'static/commons/commons', 'static/commons/ad.channel'],
